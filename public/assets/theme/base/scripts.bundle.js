...
var mPortlet = function(elementId, options) {
    ...
    var Plugin = {
        ...
        build: function() {
            ...
            var help = mUtil.find(the.head, '[m-portlet-tool=help]');
            if (help) {
                mUtil.addEvent(help, 'click', function(e) {
                    e.preventDefault();
                    Plugin.help();
                });
            }
        ...
        setupTooltips: function() {
            if (the.options.tooltips) {
                ...
                if (help) {
                    var placement = (fullscreenOn ? 'bottom' : 'top');
                    var tip = new Tooltip(help, {
                        title: the.options.tools.help,
                        placement: placement,
                        offset: (fullscreenOn ? '0,10px,0,0' : '0,5px'),
                        trigger: 'hover',
                        template: '<div class="m-tooltip m-tooltip--portlet tooltip bs-tooltip-' + placement + '" role="tooltip">\
                    ...
                    mUtil.data(help).set('tooltip', tip);
                }
        ...
        removeTooltips: function() {
            if (the.options.tooltips) {
                ...
                //== Help
                var help = mUtil.find(the.head, '[m-portlet-tool=help]');
                if (help && mUtil.data(help).has('tooltip')) {
                    mUtil.data(help).get('tooltip').dispose();
                }
            }
        },
